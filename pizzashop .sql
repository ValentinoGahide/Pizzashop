...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 21 jan 2015 om 15:26
-- Serverversie: 5.6.16
-- PHP-versie: 5.5.11
...
-- Databank: `pizzashop`
--
CREATE SCHEMA IF NOT EXISTS `pizzashop` (
...
INSERT INTO `plaats` (`postcode`, `plaats`, `leverplaats`) VALUES
(8500, 'Kortrijk', 1),
(8501, 'Bissegem', 1),
(8501, 'Heule', 1),
(8510, 'Bellegem', 1),
